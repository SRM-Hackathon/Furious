...
public partial class Default7 : System.Web.UI.Page
{
    ...
    protected void Button3_Click1(object sender, EventArgs e)
    {
      ...
      //  string uid = Request.QueryString["id"];
          String uid = "vidhi2402@gmail.com";
        SqlCommand cmd = new SqlCommand("update Users SET  First_Name= '" + TextBox1.Text  +"',Last_Name='" + TextBox2.Text + "',Password='" + TextBox4.Text + "',Address1='" + TextBox6.Text + "',Address2='" + TextBox7.Text + "',City='" + TextBox8.Text +"', Pincode='" + TextBox10.Text + "',State='" + TextBox9.Text + "',Mob_no='" + TextBox11.Text + "',Email='" + TextBox3.Text + "' where Email='" + uid + "'", con);
        cmd.Connection = con;
        cmd.ExecuteNonQuery();
