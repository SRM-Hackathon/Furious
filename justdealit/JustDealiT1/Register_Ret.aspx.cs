...
public partial class Register_Ret : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        z += 100;
        bid = "R" + z.ToString();
        SqlCommand cmd = new SqlCommand("insert into Users Values('" + bid + "','" + inputFName1.Text + "','" + inputLnam.Text + "','" + inputPassword2.Text + "','" + address.Text + "','" + address2.Text + "','" + city.Text + "','" + postcode.Text + "','" + state.SelectedItem.Text + "', '" + mobile.Text + "','" + input_email.Text + "')", con);
        cmd.ExecuteNonQuery();
        // Label1.Text = "Hi";
