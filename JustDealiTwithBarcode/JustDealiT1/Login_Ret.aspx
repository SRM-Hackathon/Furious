			...
			<h5>ALREADY REGISTERED ?</h5>
			  ...
			  <div class="control-group">
				<div class="controls">
                      ...
                      <asp:Button ID="Button1" runat="server" Text="Sign In" class="btn" OnClick="Button1_Click"/><br />
                    <asp:LinkButton ID="LinkButton1" Text="forget Password?" runat="server" OnClick="LinkButton1_Click"></asp:LinkButton>
