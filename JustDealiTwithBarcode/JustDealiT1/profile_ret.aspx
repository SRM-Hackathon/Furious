<%@ Page Title="" Language="C#" MasterPageFile="~/Display1.Master" AutoEventWireup="true" CodeFile="profile_ret.aspx.cs" Inherits="profile_ret" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h1> PROFILE  </h1>
          ...
          <td>
              <asp:Button ID="Button2" runat="server" Text="SAVE"  OnClick="Button1_Click" /> 
