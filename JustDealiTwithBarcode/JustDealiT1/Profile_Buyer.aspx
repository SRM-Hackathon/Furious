<%@ Page Title="" Language="C#" MasterPageFile="~/Buy.master" AutoEventWireup="true" CodeFile="Profile_Buyer.aspx.cs" Inherits="Default7" %>
        ...
        <div class="content_right">
                    <table class="auto-style1">
                        ...
                        <tr>
                            ...
                            <td class="auto-style25">&nbsp;<td class="auto-style23"> &nbsp;</td> 
                                <h3> STEP 1 </h3></td> 
                        ...
                        <tr><td></td>
                           <td>
                            ...
                            <asp:Button ID="Button1" runat="server" Text="EDIT" value=" EDIT"  data-toggle="modal" style="border-style: solid; padding-right:0; background-color: #00CC00; font-size: large; color: #FFFFFF; font-weight: bolder; font-style: normal; height: 73px;width:170px" /> 
                                    </td>--%>
          ...
          <td>
              <asp:Button ID="Button1" runat="server" Text="SAVE"  OnClick="Button1_Click" /> 
                            ...
                            <%--<td>
                                    <asp:Button ID="Button2" runat="server" Text="SAVE" value=" SAVE"  data-toggle="modal" style="border-style: solid; padding-right:0; background-color: #00CC00; font-size: large; color: #FFFFFF; font-weight: bolder; font-style: normal; height: 73px;width:170px" />                            </td>
                        </tr>--%>
                    </table></div>
        <style type="text/css">
        .auto-style1 {
